      ...
      <div>
        ...
        <section className="textured-section">
          ...
          <ul className="products">
            <li>
              <img className="product-image" src="images/products/071715_Heroku_3270-.jpg" alt="asdsd" />
            ...
            <li>
              <img className="product-image" src="images/products/071715_Heroku_3263-.jpg" alt="bla bla da " />
            ...
            <li>
              <img className="product-image" src="images/products/071715_Heroku_3209-.jpg" alt="slal kfj" />
            ...
            <li>
              <img className="product-image" src="images/products/071715_Heroku_3302.jpg" alt="skskee  ww" />
        ...
        <section>
          ...
          <ul className="kits">
            <li>
              <img className="kit-image" src="images/kits/071715_Heroku_3338-Edit-.jpg" alt="heroku  ss" />
            ...
            <li>
              <img className="kit-image" src="images/kits/071715_Heroku_3353-Edit-.jpg" alt="saaa aaa" />
            ...
            <li>
              <img className="kit-image" src="images/kits/071715_Heroku_3346-.jpg" alt="as phdodto" />
            ...
            <li>
              <img className="kit-image" src="images/kits/071715_Heroku_3376-Edit-.jpg" alt="produaaaact aaaa" />
            ...
            <li>
              <img className="kit-image" src="images/kits/071715_Heroku_3385-.jpg" alt="aaaa photaaaao" />
